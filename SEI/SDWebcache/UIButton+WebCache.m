...
- (void)setNormalImage:(NSString *)normalImage andHighlightedImage:(NSString *)highlightedImage
{
...
- (void)setNormalImage:(NSString *)normalImage highlightedImage:(NSString *)highlightedImage andSelectedImage:(NSString *)selectedImage
{
    [self setNormalImage:normalImage andHighlightedImage:highlightedImage];
    [self setImage:[UIImage imageNamed:selectedImage] forState:UIControlStateSelected];
}

- (void)setNormalBackgroundImage:(NSString *)normalImage andHighlightedImage:(NSString *)highlightedImage
{
